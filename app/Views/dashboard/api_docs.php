                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <section id="overview" class="doc-section p-4">
                                ...
                                <p>The <strong>RioConsoleJSON API</strong> provides secure, RESTful access to your JSON silos. You can use it to list, retrieve, and download your JSON files programmatically. All requests require authentication with an API key.</p>
                                <div class="alert alert-info mb-3">
                                    <i class="bi bi-lightbulb me-2"></i>
                                    <strong>Tip:</strong> You can test the API on different environments (localhost, staging, production) by changing the <strong>Base URL</strong> in your client or test page.
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Base URL</h6>
                            ...
                            <section id="authentication" class="doc-section p-4">
                                ...
                                <p>All API requests must include your API key in the <code>Authorization</code> header. Two formats are supported:</p>
                                ...
                                <h6 class="mt-3">API Key Header (Alternative)</h6>
                                <div class="code-block">
                                ...
                                <div class="alert alert-secondary mt-2">
                                    ...
                                    API keys are unique and secret. Never share your API key publicly.
                                </div>
                            </section>
                            ...
                            <section id="domain-lock" class="doc-section p-4">
                                ...
                                <p>Protect your API keys with domain-based access restrictions. When enabled, your API key will only accept requests from specified domains, even if the key is exposed.</p>
                                <div class="alert alert-warning">
                                    <i class="bi bi-exclamation-triangle me-2"></i>
                                    <strong>Security Feature:</strong> Domain lock prevents unauthorized domains from using your API key.
                                </div>
                                ...
                                <ol>
                                    <li><code>Origin</code> header (for CORS/browser requests)</li>
                                            ...
                                            <pre class="language-json"><code>HTTP/1.1 403 Forbidden
{
  ...
  "timestamp": "2025-06-26T08:11:30+00:00"
                            ...
                            <section id="endpoints" class="doc-section p-4">
                                ...
                                <div class="mb-4">
                                    <strong>All endpoints are under:</strong> <code><?= $base_url ?>api/v1/</code>
                                </div>
                                <!-- Health Check -->
                                <div class="endpoint-card p-3 mb-3">
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="method-badge method-get me-2">GET</span>
                                        <code>/api/v1/health</code>
                                    </div>
                                    <p>Check API server status. No authentication required.</p>
  ...
  "data": {
    "status": "healthy",
    "server_time": "2025-06-30T16:14:11+08:00",
    "version": "1.0.0"
  },
  "timestamp": "2025-06-30T16:14:11+08:00"
}</code></pre>
                                    </div>
                                </div>
                                <!-- API Info -->
                                <div class="endpoint-card p-3 mb-3">
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="method-badge method-get me-2">GET</span>
                                        <code>/api/v1/info</code>
                                    </div>
                                    <p>Get API metadata, supported endpoints, authentication, and rate limit information. No authentication required.</p>
                                    <h6>Example Request</h6>
                                    <div class="code-block">
    ...
    "timestamp": "2025-06-30T16:13:47+08:00"
}</code></pre>
                                    </div>
                                </div>
                                <!-- Get All Files -->
    ...
    "data": [1, 2, 3, 4, 5]
                            ...
                            <section id="examples" class="doc-section p-4">
                                ...
                                <div class="alert alert-info mb-3">
                                    <i class="bi bi-lightbulb me-2"></i>
                                    <strong>Tip:</strong> You can change the API base URL in your client or test page to test against localhost, staging, or production.
                                </div>
                                <!-- JavaScript Example -->
                                <h5>JavaScript (fetch)</h5>
                                <div class="code-block">
                                    <pre class="language-javascript"><code>// Set your API base URL
...
async function getFile(fileId) {
  const response = await fetch(`${API_BASE}/${USER_ID}/${fileId}`, {
    headers: {
      'Authorization': `Bearer ${API_KEY}`
    }
  });
...
# Get raw JSON
curl -H "Authorization: Bearer your-api-key-here" \
     <?= $base_url ?>api/v1/<?= $user_id ?>/123-456-789/raw
</code></pre>
                                    <button class="copy-code-btn" onclick="copyCodeBlock(this)">Copy</button>
                                </div>
                                <!-- Python Example -->
...
print(f"Domain lock test: {response.status_code}")
</code></pre>
                                    <button class="copy-code-btn" onclick="copyCodeBlock(this)">Copy</button>
                                </div>
                            </section>
                            ...
                            <section id="errors" class="doc-section p-4">
                                ...
                                <p>The API returns standard HTTP status codes and JSON error responses. All errors include a message and timestamp.</p>
                                <h6>Error Response Format</h6>
                                <div class="code-block error-example">
                                    <pre class="language-json"><code>{
    "error": true,
    "message": "Invalid or missing API key",
    "timestamp": "2025-06-30T16:11:30+08:00"
}</code></pre>
                                    <button class="copy-code-btn" onclick="copyCodeBlock(this)">Copy</button>
                                </div>
                            ...
                            <section id="rate-limits" class="doc-section p-4">
                                ...
                                <p>To ensure fair usage, the API implements the following rate limits. <strong>Admin users have unlimited access.</strong></p>
                                ...
                                <?php if (isset($is_admin) && $is_admin): ?>
                                    <div class="alert alert-danger">
                                        ...
                                        <div class="mt-3"><strong>Admin users:</strong> Unlimited for all limits.</div>
                                    </div>
                                <?php endif; ?>
